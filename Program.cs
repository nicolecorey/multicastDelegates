...
namespace assignment8ex1
{
    class Program
    {
        ...
        {
            songDelegate s = new songDelegate(HereComesTheSun.chorus);
            s += HereComesTheSun.verse1;
            s += HereComesTheSun.chorus;
            s += HereComesTheSun.verse2;
            s += HereComesTheSun.chorus2;
            s += HereComesTheSun.verse3;
            s += HereComesTheSun.chorus;
            s += HereComesTheSun.chorus;
            s += HereComesTheSun.end;
            s();
        }
    }
}
